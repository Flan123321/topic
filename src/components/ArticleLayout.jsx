                        ...
                        <aside className="lg:col-span-4 space-y-8">
                            ...
                            <div className="sticky top-8 bg-white p-6 rounded-xl shadow-lg border-t-4 border-blue-600">
                                ...
                                <div className="space-y-3">
                                    <Link to="/vender" className="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-4 rounded-lg transition-all shadow-md transform hover:-translate-y-0.5 flex justify-center items-center">
                                    ...
                                    <Link to="/unirme" className="w-full bg-white hover:bg-gray-50 text-blue-700 font-bold py-3 px-4 rounded-lg border-2 border-blue-600 transition-all flex justify-center items-center">
